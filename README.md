...
<img src="https://github.com/Zhihan-Leo-Liu/DosaCNV/blob/main/fig1.jpg"  width="50%" height="25%">
...
The ['precomputed_gene_score.tsv'](link) file contains precomputed DosaCNV-HI scores for 19,573 autosomal protein-coding genes. These scores are predictions of gene haploinsufficiency described in [our manuscript](link), indicating how likely the loss of one copy of each gene is to cause disease.
